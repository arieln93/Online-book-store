...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class<? extends Message>, Callback> callbackConcurrentHashMap;
    private MessageBusImpl messageBusInstance = MessageBusImpl.getInstance();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        callbackConcurrentHashMap.put(type,callback);
    }
    ...
    protected final <T> Future<T> sendEvent(Event<T> e) {
        Future<T> f = messageBusInstance.sendEvent(e);
        return f;
    }
    ...
    public final void run() {
        ...
        initialize();
        BookStoreRunner.count.incrementAndGet();
        while (!terminated) {
            try {
                Message m = messageBusInstance.awaitMessage(this);
                callbackConcurrentHashMap.get(m.getClass()).call(m);
